...
def calc_perc_credit(data):
  total = 0
  credit_string = "4 3 3 3 3 3 3 1 1 1 2 1"
  sub = dict(maths=4,physics=3,evs=3,itp=3,em=3,es=3,cs=3,phylab=1,evslab=1,clab=1,emlab=2,eslab=1)
  for s in sub:
...
for n in xrange(n):
  ...
  data = dict(rollno=re.sub("[^0-9]","",records[n][0]),name=records[n][1],perc_credit=None,perc=None,
            credit_string="4 3 3 3 3 3 3 1 1 1 2 1",maths=form_marks(n,x),
